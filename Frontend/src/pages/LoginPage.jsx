...
const LoginPage = () => {
  ...
  className={`
    ...
    ${isSigningIn 
      ...
      : 'bg-gradient-to-r from-[#7A5FFF] to-[#5F4BFF] hover:from-[#6E52FF] hover:to-[#5442FF] hover:scale-[1.02] hover:shadow-xl hover:shadow-[#7A5FFF]/30 active:scale-[0.98] cursor-pointer'
    }
  `}
